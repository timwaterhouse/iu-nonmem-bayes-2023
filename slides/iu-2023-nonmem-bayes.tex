...
%  \textcolor{mrgteal}{Lunch: 12:00--1:00pm}
  \begin{itemize}
  % \item Example 1: Example illustrating Bayesian data analysis
  %   workflow
...
%  \textcolor{mrgteal}{Break: 3:00--3:15pm}
  \begin{itemize}
  % \item Example 2: MAP popPK with selective use of informative priors
...
%  \textcolor{mrgteal}{Day 2 (cont.)}
  % \begin{itemize}
  % \item Example 4: Full Bayes popPKPD using semi-mechanistic model
  %   \begin{itemize}

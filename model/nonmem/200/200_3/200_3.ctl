...
$EST METHOD=CHAIN FILE=../200.chn NSAMPLE=0 ISAMPLE=3 SEED=1 CTYPE=0 IACCEPT=0.3 DF=10 DFS=3
$EST METHOD=NUTS AUTO=2 SEED=3 NBURN=500 NITER=1000 PRINT=1 MSFO=./200.msf RANMETHOD=P PARAFPRINT=10000 BAYES_PHI_STORE=1
